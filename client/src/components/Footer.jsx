        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">Clinix Couture</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Premium medical apparel designed for healthcare professionals. 
              Comfort, style, and durability in every piece.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=Scrubs" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Scrubs
                </Link>
              </li>
              <li>
                <Link to="/products?category=Lab Coats" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Lab Coats
                </Link>
              </li>
              <li>
                <Link to="/products?category=Medical Shoes" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Medical Shoes
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="flex max-w-md">
              ...
              />
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-r-lg transition-colors duration-200">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="md:flex md:items-center md:justify-between">
            <div className="text-sm text-gray-400">
              <p>&copy; 2024 Clinix Couture. All rights reserved.</p>
            </div>
